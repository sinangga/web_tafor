...
with tab3:
   ...
   st.image("bom.gov.au/climate/enso/wrap-up/archive/20240109.sstOutlooks_nino34.png", width=None)

with tab4:
   st.header("IOD")
   st.image("bom.gov.au/clim_data/IDCK000072/iod1.png", width=None)

...
with tab1:
   ...
   with st1:
      st.image("https://web.meteo.bmkg.go.id//media/data/bmkg/streamline//T_PGXA15_C_WIIX_"+str(tl1.strftime('%Y'))+str(tl1.strftime('%m'))+str(tl1.strftime('%d'))+"120000.STREAMLINES925.png", width=None)      
   with st2:
